...
This mechanism has been integrated into Bitcore-Node-Hive which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Hive-Project/insight-api-hive#web-socket-api](https://github.com/Hive-Project/insight-api-hive#web-socket-api) 
* API: [https://github.com/Hive-Project/insight-api-hive#swifttx-transactions](https://github.com/Hive-Project/insight-api-hive#swifttx-transactions) 
...
By default, the Hive Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hive Core daemon:
