...
```
./hived -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./hived -proxy=127.0.0.1:9050
```

Run a Hive hidden server
-------------------------------
...
HiddenServicePort 989 127.0.0.1:1234
...
your hived's P2P listen port (1234 by default).
```
...
```
./hived -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 1234 on your firewall (or use -upnp).

If you only want to use Tor to reach onion addresses, but not use it as a proxy
for normal IPv4/IPv6 communication, use:
```
./hived -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known Hive Tor relays
------------------------------------
```
