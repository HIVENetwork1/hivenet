...
In order to support loading of multiple wallets in hive-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hive.cpp.
...
Changes to hive.cpp
----------------------
hive.cpp is the entry point into hive-qt, and as such, will require some minor modifications to provide hooks for
