...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hive features */
        {"hive", "masternode", &masternode, true, true, false},
        {"hive", "listmasternodes", &listmasternodes, true, true, false},
        {"hive", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hive", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hive", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hive", "masternodedebug", &masternodedebug, true, true, false},
        {"hive", "startmasternode", &startmasternode, true, true, false},
        {"hive", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hive", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hive", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hive", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hive", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hive", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hive", "mnbudget", &mnbudget, true, true, false},
        {"hive", "preparebudget", &preparebudget, true, true, false},
        {"hive", "submitbudget", &submitbudget, true, true, false},
        {"hive", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hive", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hive", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hive", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hive", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hive", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hive", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hive", "checkbudgets", &checkbudgets, true, true, false},
        {"hive", "mnsync", &mnsync, true, true, false},
        {"hive", "spork", &spork, true, true, false},
        {"hive", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hive", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hived, or the -server option to hive-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hive-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5523/\n";
}
