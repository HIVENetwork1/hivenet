...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x00000f2f8b9feafcb38284dc4db6fe239ab67163d4a81c4fc8660628fc2e1271"));
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x00000f2f8b9feafcb38284dc4db6fe239ab67163d4a81c4fc8660628fc2e1271"));
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "1st August 2018 - HIVE - The day you'll remember.";
        ...
        genesis.nNonce = 841031;
		//MineGenesis(genesis);
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f2f8b9feafcb38284dc4db6fe239ab67163d4a81c4fc8660628fc2e1271"));
        assert(genesis.hashMerkleRoot == uint256("0x06009e6b226a4d51fb30b80f5fee4bd259526b609440face4fa9367e1ff171db"));

        vSeeds.push_back(CDNSSeedData("mainseed.hiveseednodes.org", "140.82.11.40"));
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet hive addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet hive script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet hive BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet hive BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet hive BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Hive: 1 day
        nTargetSpacing = 1 * 60;        // Hive: 1 minutes
